...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Julienne General Enterprises" },
      ...
      { name: "twitter:title", content: "Shop Dashboard — Julienne General Enterprises — Home of Snacks" },
      { name: "twitter:description", content: "Daily overview for your snack shop: money made today, snacks in stock, running-low alerts and one-tap shortcuts to sell, restock or record expenses in UGX." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/b43e7227-1f7a-468f-981a-dae6de457950" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/b43e7227-1f7a-468f-981a-dae6de457950" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo:wght@600;700;800;900&family=Plus+Jakarta+Sans:wght@400;500;600;700;800&display=swap",
      },
    ],
  }),
